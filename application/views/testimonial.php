...
<!-- Mirrored from www.ocsolutions.co.in/html/organic_food/testimonial.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Jul 2022 10:46:36 GMT -->
<meta charset="utf-8"/>
...
<div class="bread-crumb">
	...
	<div class="container">
		<div class="matter">
			<h2><span>Organic</span> Testimonial</h2>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-6 col-md-6 col-lg-6 col-xs-12">
				<div class="box">
					<img src="images/header3/test1.png" class="img-fluid" alt="img" title="img">
					<p><i class="icon_quotations first"></i> Vestibulum ligula sodales, eleifend nunc. Morbi sapien quam, accumsan non dolor nec, posuere iaculis libero. Lorem ipsum dolor sit amet, consectetur adipiscing elit <i class="icon_quotations last"></i></p>
				</div>
			</div>
			<div class="col-sm-6 col-md-6 col-lg-6 col-xs-12">
				<div class="box">
					<img src="images/header3/test2.png" class="img-fluid" alt="img" title="img">
					<p><i class="icon_quotations first"></i> Vestibulum ligula sodales, eleifend nunc. Morbi sapien quam, accumsan non dolor nec, posuere iaculis libero. Lorem ipsum dolor sit amet, consectetur adipiscing elit <i class="icon_quotations last"></i></p>
				</div>
			</div>
			<div class="col-sm-6 col-md-6 col-lg-6 col-xs-12">
