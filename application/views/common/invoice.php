...
$data= $this->app_model->select_all('item_orders',$where);

$single_data= $this->app_model->select_one('item_orders',$where);

$where = [
  'id' => $single_data->customer_id
];
$customer = $this->app_model->select_one('item_customer',$where);
$date = new DateTime($single_data->created_at); 
?>
                                    ...
                                    <td>
                                        <table width="220" border="0" cellpadding="0" cellspacing="0" align="left"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="left"> <img
                                                            src="<?=base_url()?>assets/images/invoice.jpeg" width="100"
                                                ...
                                                <tr>
                                                    <td
                                                        style="font-size: 12px; color: #5b5b5b; font-family: 'Open Sans', sans-serif; line-height: 18px; vertical-align: top; text-align: left;text-transform: uppercase;">
                                                        HELLO ,
                                                        <?=$customer->name?> ,
                                                        <br> Thank you for shopping with Itemary
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td
                                                        ...
                                                        <small>ORDER ID - </small> <?=@$single_data->order_id?><br />
                                                        <small>ORDER DATE -
                                                            <?php echo @$date->format('d-M-Y '); ?></small>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                          ...
                          ?>
                                        ...
                                        <tr>
                                            ...
                                            <td
                                                ...
                                                <small><?=@$item->product_qty?></small>
                                            </td>
                                            <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e;  line-height: 18px;  vertical-align: top; padding:10px 0;"
                                                align="center"><?=@$item->product_unit?></td>
                                            ...
                                            <td>
                                                <table width="220" border="0" cellpadding="0" cellspacing="0"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td
                                                                style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #5b5b5b; line-height: 20px; vertical-align: top; text-transform: uppercase ">
                                                                <?=$customer->address?>
                                                            </td>
                                                        </tr>
                                                    </tbody>
