									...
									<tbody>
										<tr>
											<td class="text-center">
												<img src="images/header1/deal-img6.png" class="img-fluid" alt="img" title="img" />
											</td>
											<td class="text-left">
										...
										<tr>
											<td class="text-center">
												<img src="images/header1/deal-img3.png" class="img-fluid" alt="img" title="img" />
											</td>
											<td class="text-left">
												<a href="#">Your Product Title</a>
												<p>1 x $ 15.00</p>
										...
										<tr>
											<td class="text-center">
												<img src="images/header1/deal-img1.png" class="img-fluid" alt="img" title="img" />
											</td>
											<td class="text-left">
												<a href="#">Your Product Title</a>
												<p>1 x $ 15.00</p>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12 col-lg-12 col-xs-12">
				<div id="logo">
					<a href="index-2.html">
						<img class="img-fluid logochange" src="images/header1/logo.png" alt="logo" title="logo" />
					</a>
				</div>
			</div>	
							...
							<ul class="nav navbar-nav text-right">
								<li class="dropdown topheader">
									...
									<div class="dropdown-menu">
										...
										<div class="col-sm-3">
											<img src="images/header1/free-shipping.png" class="img-fluid" alt="img" title="img" />
										</div>
										</div>
									</div>
								</li>
...
<div class="bread-crumb">
	<img src="images/top-banner.jpg" class="img-fluid" alt="banner-top" title="banner-top">
	<div class="container">
		<div class="matter">
			<h2><span>Organic</span> Login / Register</h2>
		...
		<div class="row">
			<div class="col-md-6 col-sm-6 col-xs-12 box">
				...
				<form method="post" enctype="multipart/form-data">
					<div class="form-group">	
						...
						<input type="text" name="email" value="" placeholder="Your Email" id="input-email" class="form-control" required/>
					</div>
					<div class="form-group">
						<label>password *</label>
						<input type="text" name="password" value="" placeholder="Password" id="input-password" class="form-control" required/>
					</div>
					<div class="links">
						<input class="checkclass checkbox-inline" type="checkbox">Remember Me!
						<a href="#" class="float-right">Forgot your account?</a>
					</div>
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				...
				<form method="post" enctype="multipart/form-data">
					<div class="form-group">	
						<label>Email Address *</label>
						<input type="text" name="mail" value="" placeholder="Your Email" id="input-mail" class="form-control" required/>
					</div>
					<div class="form-group">	
						<label>Username *</label>
						<input type="text" name="username" value="" placeholder="John Doe" id="input-username" class="form-control" required/>
					</div>
					<div class="form-group">
						<label>password *</label>
						<input type="text" name="password1" value="" placeholder="Password" id="input-password1" class="form-control" required/>
					</div>
					<div class="form-group">
						<label>confirm password*</label>
						<input type="text" name="confirmpassword" value="" placeholder="Password" id="input-confirmpassword" class="form-control" required/>
					</div>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm-3 col-md-3 col-lg-3 col-xs-12">
				<img src="images/header1/footer_logo.png" class="img-fluid footerlogochange" title="logo" alt="logo">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xs-12 text-right">
					<ul class="list-inline">
						<li>
							<img src="images/card1.png" class="img-fluid" alt="card" title="card" />
						</li>
						<li>
							<img src="images/card2.png" class="img-fluid" alt="card" title="card" />
						</li>
						<li>
							<img src="images/card3.png" class="img-fluid" alt="card" title="card" />
						</li>
						<li>
							<img src="images/card4.png" class="img-fluid" alt="card" title="card" />
						</li>
						<li>
							<img src="images/card5.png" class="img-fluid" alt="card" title="card" />
						</li>
						<li>
							<img src="images/card6.png" class="img-fluid" alt="card" title="card" />
						</li>
					</ul>
				</div>
			</div>	
...
<!-- Mirrored from www.ocsolutions.co.in/html/organic_food/login_register.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 05 Jul 2022 10:45:41 GMT -->
</html>