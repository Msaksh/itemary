...
function selectImage(id){
  $('#profileInput'+id).click();
}

function PreviewImage(id1) {
  var oFReader = new FileReader();
  oFReader.readAsDataURL(document.getElementById('profileInput'+id1).files[0]);

  oFReader.onload = function (oFREvent) {
    $(".cancel"+id1).removeClass('d-none');
    document.getElementById('profileImg'+id1).src = oFREvent.target.result;
  };
};
...
function cancelImage(id){
  ...
  $("#profileInput"+id).val('');
  $("#profileImg"+id).attr('src', base_url+'assets/images/blank.jpg');
}

function cancel2Image(id){
  $("#imageExiest"+id).val('');
  $(".cancel"+id).addClass('d-none');
  $("#profileInput"+id).val('');
  $("#profileImg"+id).attr('src', base_url+'assets/images/no-featured.png');
}
