                                        ...
                                        <table class="table" id="myTable">
                                            ...
                                            <thead>
                                                ...
                                                <tr class="ul-widget6__tr--sticky-th">
                                                    ...
                                                    <th scope="col">Replace Reason</th>
                                            ...
                                            <tbody>
                                                ...
                                                <!-- start tr-->
                                                <?php $order=1; $i=0; foreach ($orders as $key => $value) {                                         

                                              if($value->order_id!=$order){
                                    ...
                                    $customer = $this->appmodel->select_one('item_customer',$where);?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?=site_url('orders/view_order/'.$value->order_id)?>"
