...
<head>
    <title><?=NAME?> | Service Area Pincode</title>
                    ...
                    <div class="col-sm-12 p-0">
                        <div class="main-header">
                            ...
                            <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                                ...
                                <li class="breadcrumb-item"><a href="#">Pincode</a>
                                </li>
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <h5 class="card-header-text">Pincode List</h5>
                                    </div>
                                    <div class="col-sm-6 text-right">
                                        <a href="<?=base_url('pincode/create')?>" class="btn btn-success"><i
                                                class="icon-plus"></i></a>
                                    </div>
                                </div>
                                        ...
                                        <table class="table" id="myTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <!--  -->
                                                    <td style="padding-left: 20px;">
                                                        <a href="<?=site_url('pincode/edit/'.$value->id)?>"
                                                            class="btn btn-success">
                                                            <i class="icon-pencil"></i>
                                                        </a>

                                                        <a href="<?=base_url()?>pincode/delete/<?=$value->id?>"
