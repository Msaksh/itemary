...
<head>
   <title><?=NAME?> | Add New Pincode</title>
               ...
               <div class="col-sm-12 p-0">
                  <div class="main-header">
                     ...
                     <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('product')?>">Pincodes</a>
                        <li class="breadcrumb-item"><a href="#">Add New Pincode</a>
                        </li>
                     </ol>
                  </div>
               </div>
               ...
               <div class="col-sm-12">
                  ...
                  <div class="card">
                     <div class="card-block">
                        <form action="<?=base_url('pincode/create')?>" id="form" method="post"  enctype="multipart/form-data">
                    <div class="row mt-3">
                        <div class="col-sm-9">
                            <div class="card p-10">
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="title" type="text" class="form-control" id="title" placeholder="Area name ?">                                        
                                    </div>   
                                     <div class="form-group mb-3">
                                        <label for="title">Pincode <span class="text-danger">*</span></label>
                                        <input  name="pincode" type="text" class="form-control" id="pincode" minlength="1" maxlength="6" placeholder="Pincode ?" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');">                                        
                                    </div>                               
                                  </div>
                                </div>
                        </div>
