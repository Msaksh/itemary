...
<head>
   <title><?=NAME?> | Pincode Update</title>
               ...
               <div class="col-sm-12 p-0">
                  <div class="main-header">
                     ...
                     <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('service_card_category')?>">Pincode</a>
                        </li>
                        <li class="breadcrumb-item"><a href="#">Manage Pincode</a>
                        </li>
                     </ol>
                  </div>
               </div>
               ...
               <div class="col-sm-12">
                ...
                <div class="card">
                     <div class="card-block">
                        <form action="<?=base_url('pincode/edit/'.$item->id)?>" id="form" method="post"  enctype="multipart/form-data">
                    <div class="row mt-3">
                        <div class="col-sm-9">
                            <div class="card p-10">
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="title" type="text" value="<?=$item->area_name?>" class="form-control" id="title" placeholder="Area Name ?">                                        
                                    </div>
                                     <div class="form-group mb-3">
                                        <label for="title">Pincode <span class="text-danger">*</span></label>
                                        <input  name="pincode" type="text" value="<?=$item->pincode?>" class="form-control" id="pincode" placeholder="Pincode" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" minlenght="1" maxlength="6">                                        
                                    </div>   
                        ...
                        <div class="col-sm-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="<?=base_url('pincode')?>" class="btn btn-sm btn-outline-info btn-rounded m-1">Cancel</a>
                                </div>
                            </div>
