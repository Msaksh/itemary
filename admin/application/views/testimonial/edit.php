                            ...
                            <div class="card-body">
                                <div class="card-title">Testimonial Image
                                    ...
                                    <div class="text-center">
                                        <?php if($item->image && file_exists(FCPATH.'/assets/images/testimonial/'.$item->image)){ ?>
                                        <img class="img-fluid" onclick="selectImage('1')" src="<?=base_url('assets/')?>images/testimonial/<?=$item->image?>" id="profileImg1" />
                                        <?php }else{ ?>
