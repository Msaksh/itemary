...
<head>
   <title><?=NAME?> | Service Card Update</title>
               ...
               <div class="col-sm-12">
                ...
                <div class="card">
                     <div class="card-block">
                        <form action="<?=base_url('item_units_category/edit/'.$item->id)?>" id="form" method="post"  enctype="multipart/form-data">
                    <div class="row mt-3">
                        <div class="col-sm-9">
                            <div class="card p-10">
                                <div class="card-body">
                        ...
                        <div class="col-sm-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="<?=base_url('service_card_category')?>" class="btn btn-sm btn-outline-info btn-rounded m-1">Cancel</a>
                                </div>
                            </div>
