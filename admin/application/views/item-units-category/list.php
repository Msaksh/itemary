...
<head>
    ...
    <title><?=NAME?> | Item Unit List</title>
                            ...
                            <div class="card-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <h5 class="card-header-text">Units List</h5>

                                    </div>

                                    <div class="col-sm-6 text-right">

                                        <a href="<?=base_url('item_units_category/create')?>" class="btn btn-success"><i
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 20px;">
                                                        ...
                                                        <a href="<?=site_url('item_units_category/edit/'.$value->id)?>"
                                                        ...
                                                        <a href="<?=base_url()?>item_units_category/delete/<?=$value->id?>"
