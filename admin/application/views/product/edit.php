               ...
               <div class="col-sm-12">
                ...
                <div class="card">
                     ...
                     <div class="card-block">
                        ...
                        <form action="<?=base_url('product/edit/'.$item->id)?>" id="form" method="post"  enctype="multipart/form-data">
                                   ...
                                   <div class="form-group mb-3">
                                     <label for="title">Select Category <span class="text-danger">*</span></label>
                                       ...
                                       <?php } ?>
                                        ...
                                        <label for="title">Select Unit <span class="text-danger">*</span></label>

                                       <select name="unit_id" class="form-control">

                                       <?php foreach($unit as $value){ ?>

                                            <option value="<?=$value->id?>" <?=in_array($value->id, explode(',',$item->unit_id))?'selected':''?>><?=$value->name?></option>
                                     ...
                                     <div class="form-group mb-3">
                                        <label for="title">Enter Quantity  <span class="text-danger">*</span></label>

                                        <input name="qty" value="<?=$value->id?>" type="text" class="form-control"  placeholder="Enter Quantity">                                        
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="price" value="<?=$item->price?>" type="text" class="form-control" id="title" placeholder="Product Price ?">                                        
                                    ...
                                    <div>
                                        ...
                                        <textarea name="details" id="editor" placeholder="Blog Details"><?=$item->details?></textarea>
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="<?=base_url('product')?>" class="btn btn-sm btn-outline-info btn-rounded m-1">Cancel</a>
                        ...
                        <div style="margin-bottom: 10px !important" class="card mt-3  p-3">                           
                             ...
                             <div class="card p-10">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="card-title">Product Image
                                    ...
                                    <div class="text-center">
                                        ...
                                        <?php if($item->image && file_exists(FCPATH.'/assets/images/product/'.$item->image)){ ?>

                                        <img class="img-fluid" onclick="selectImage('1')" src="<?=base_url('assets/')?>images/product/<?=$item->image?>" id="profileImg1" />
