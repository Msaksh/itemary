...
<head>
    ...
    <link rel="icon" href="<?=base_url()?>assets/itemary-logo.png" type="image/x-icon">
                            ...
                            <div class="card-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 text-right">
                                        ...
                                        <a href="<?=base_url('product/create')?>" class="btn btn-success"><i
                                        ...
                                        <table class="table" id="myTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                        ...
                                                        <span>
                                                            ...
                                                            <div class="ul-widget_user-card">
                                                                ...
                                                                <div class="ul-widget4__img">
                                                                    ...
                                                                    <?php if($value->image && file_exists(FCPATH.'/assets/images/product/'.$value->image)){ ?>

                                                                    <img class="img-fluid" id="userDropdown"

                                                                        src="<?=base_url('/assets/images/product/'.$value->image)?>"
                                                    ...
                                                    <!-- <td style="padding-left: 20px;"><?=@$value->details?></td> -->

                                                    <td style="padding-left: 20px;"><?=$value->price?></td>
