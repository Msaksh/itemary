...
<head>
   ...
   <title><?=NAME?> | Product Create</title>
               ...
               <div class="col-sm-12">
                  ...
                  <div class="card">
                     ...
                     <div class="card-block">
                        ...
                        <form action="<?=base_url('product/create')?>" id="form" method="post"  enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                  ...
                                  <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="qty" type="text" class="form-control"  placeholder="Enter Quantity">                                        
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="price" type="text" class="form-control" id="title" placeholder="Product Price ?">                                        
                                    ...
                                    <div>
                                        ...
                                        <textarea name="details" id="editor" placeholder="Blog Details"></textarea>
                        ...
                        <div class="card mt-3  p-10">
                            ...
                            <div class="card-body">
                                ...
                                <div class="card-title">Banner Image
                                    ...
                                    <i class="fa fa-trash cancel cancel2 d-none" onclick="cancelImage('2')"></i>

                                </div>

                                <div class="text-center">

                                        <img class="img-fluid" onclick="selectImage('2')" src="<?=base_url('assets/')?>images/blank.jpg" id="profileImg2" />

                                        <input type="file" id="profileInput2" name="banner_image" accept="image/*" onchange="PreviewImage('2');" hidden>
