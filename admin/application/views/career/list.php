               ...
               <div class="col-sm-12">
                  ...
                  <div class="card">
                     <div class="card-header">
                        <div class="row">
                          <div class="col-sm-6"> 
                            <h5 class="card-header-text">Career List</h5>
                            <p>Basic example <code>without any additional modification</code> classes</p>
                          </div>
                          <div class="col-sm-6 text-right"> 
                            <a href="<?=base_url('career/create')?>" class="btn btn-success"><i class="icon-plus"></i></a>
                          </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="ul-widget_user-card">
                                                        ...
                                                        <?php if($value->image && file_exists(FCPATH.'/assets/images/careers/'.$value->image)){ ?>
                                                          <img class="img-fluid" id="userDropdown" src="<?=base_url('/assets/images/careers/'.$value->image)?>" alt="<?=$value->title?>" />
                                                          <?php }else{ ?>
                                                ...
                                                <td>
                                                    <a href="<?=site_url('career/edit/'.$value->id)?>" class="btn btn-success">
                                                        <i class="icon-pencil"></i>
                                                    </a>
                                                    <a href="<?=base_url()?>career/delete/<?=$value->id?>" class="btn btn-danger delete" type="button">   
