               ...
               <div class="col-sm-12">
                  ...
                  <div class="card">
                     <div class="card-block">
                        <form action="<?=base_url('career/create')?>" id="form" method="post"  enctype="multipart/form-data">
                    <div class="row mt-3">
                        <div class="col-sm-9">
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="title" type="text" class="form-control" id="title" placeholder="Career Title">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="slug">Slug</label>
                                        <input name="slug" type="text" class="form-control" id="slug" placeholder="Career slug">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="name">Headline <span class="text-danger">*</span></label>
                                        <textarea name="headline"class="form-control" id="headline" placeholder="Career Headline"></textarea>
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="editor">Details</label>
                                        <textarea name="details" id="editor" placeholder="Details"></textarea>
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group mb-3">
                                                <label for="mobile">Mobile</label>
                                                <input name="mobile" type="text" class="form-control" id="mobile" placeholder="Contact Mobile">
                                            </div>
                                        </div>
                                        <div class="col-sm-8">
                            ...
                            <div class="card p-10" style="margin-bottom: 15px;">
                                <div class="card-body">
                                  <div class="form-group">
                                        ...
                                        <input name="position" type="number" class="form-control" id="position" placeholder="Position" value="1" min="1">
                                    </div>
                                </div>
                              </div>
