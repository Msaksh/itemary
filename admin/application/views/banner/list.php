                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <!-- <div class="card-header">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <h5 class="card-header-text">Banner List</h5>
                                        <p>Basic example <code>without any additional modification</code> classes</p>
                                    </div>
                                    <div class="col-sm-6 text-right">
                                        <a href="<?=base_url('banner/create')?>" class="btn btn-success"><i
                                                class="icon-plus"></i></a>
                                    </div>
                                </div>
                                        ...
                                        <table class="table" id="myTable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                        ...
                                                        <span>
                                                            <div class="ul-widget_user-card">
                                                                <div class="ul-widget4__img">
                                                                    <?php if($value->image && file_exists(FCPATH.'/assets/images/banner/'.$value->image)){ ?>
                                                                    <img class="img-fluid" id="userDropdown"
                                                                        src="<?=base_url('/assets/images/banner/'.$value->image)?>"
                                                                        alt="<?=$value->name?>" />
                                                                    <?php }else{ ?>
                                                    ...
                                                    <td>
                                                        <a href="<?=site_url('banner/edit/'.$value->id)?>"
                                                            class="btn btn-success">
                                                            <i class="icon-pencil"></i>
                                                        </a>
                                                        <a href="<?=base_url()?>banner/delete/<?=$value->id?>"
