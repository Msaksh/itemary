               ...
               <div class="col-sm-12 p-0">
                  <div class="main-header">
                     ...
                     <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('banner')?>">Slider</a>
                        <li class="breadcrumb-item"><a href="#">Manage Slider</a>
                        </li>
                     </ol>
                  </div>
               </div>
               ...
               <div class="col-sm-12">
                  ...
                  <div class="card">
                     <div class="card-block">
                        <form action="<?=base_url('banner/edit/'.$item->id)?>" id="form" method="post"  enctype="multipart/form-data">
                    <div class="row mt-3">
                        <div class="col-sm-9">
                            <div class="card p-10">
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="title" type="text" class="form-control" id="title" placeholder="Banner Title"  value="<?=$item->name?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="<?=base_url('banner')?>" class="btn btn-sm btn-outline-info btn-rounded m-1">Cancel</a>
                                </div>
                            </div>
                            ...
                            <div class="card mt-3 p-10">
                                <div class="card-body">
                                    <div class="card-title">Banner Image <span class="text-danger">*</span></div>
                                    <div class="text-center">
                                        <?php if($item->image && file_exists(FCPATH.'/assets/images/banner/'.$item->image)){ ?>
                                        <img  class="img-fluid"  onclick="selectImage('1')" src="<?=base_url('assets/')?>images/banner/<?=$item->image?>" id="profileImg1" />
                                        <?php }else{ ?>
