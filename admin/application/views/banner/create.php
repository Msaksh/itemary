...
<head>
   <title><?=NAME?> | Slider Create</title>
               ...
               <div class="col-sm-12 p-0">
                  <div class="main-header">
                     ...
                     <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="#">Create New Slider</a>
                        </li>
                     </ol>
                  </div>
               </div>
               ...
               <div class="col-sm-12">
                  ...
                  <div class="card">
                     <div class="card-block">
                        <form action="<?=base_url('banner/create')?>" id="form" method="post"  enctype="multipart/form-data">
                    <div class="row mt-3">
                        <div class="col-sm-9">
                            <div class="card p-10">
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="title" type="text" class="form-control" id="title" placeholder="Banner Title">
                                    </div>
  ...
  <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $("#form").validate({
                ...
                messages:{
                   image:{
                    required:'Featured image required'
                   }
                }
            });
        });
