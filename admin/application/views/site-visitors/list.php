   ...
   <div class="card-header">
    <div class="row">
      ...
      <div class="col-sm-6 text-right"> 
        <a href="<?=base_url('testimonial/create')?>" class="btn btn-success"><i class="icon-plus"></i></a>
      </div>
    </div>
  </div>
          ...
          <?php $i=0; foreach ($items as $key => $value) { ?>
            <tr>
              ...
              <td>
                ...
                <a href="<?=base_url()?>visitor/delete/<?=$value->id?>" class="btn btn-danger delete" type="button">   
