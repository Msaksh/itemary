               ...
               <div class="col-sm-12 p-0">
                  ...
                  <div class="main-header">
                     ...
                     <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('product')?>">Product Category</a>
               ...
               <div class="col-sm-12">
                  ...
                  <div class="card">
                     ...
                     <div class="card-block">
                        ...
                        <form action="<?=base_url('product_category/create')?>" id="form" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="<?=base_url('product-category')?>" class="btn btn-sm btn-outline-info btn-rounded m-1">Cancel</a>
