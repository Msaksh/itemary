...
<head>
    ...
    <title><?=NAME?> | Product Category List</title>
...
<body class="sidebar-mini fixed">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 p-0">
                        ...
                        <div class="main-header">
                            ...
                            <h4>Product Category Managment</h4>
                            ...
                            <div class="card-header">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <h5 class="card-header-text">Product Category</h5>

                                    </div>

                                    <div class="col-sm-6 text-right">

                                        <a href="<?=base_url('product_category/create')?>" class="btn btn-success"><i
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="padding-left: 20px;">
                                                        ...
                                                        <a href="<?=site_url('product_category/edit/'.$value->id)?>"
                                                        ...
                                                        <a href="<?=base_url()?>product_category/delete/<?=$value->id?>"
    ...
    function updateStatus(event, id) {
        ...
        $.ajax({
            ...
            url: "<?=base_url()?>item_units_category/enable",
